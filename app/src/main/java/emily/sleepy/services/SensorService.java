...
import emily.sleepy.views.activities.USleep;
...
public abstract class SensorService extends Service implements ConnectionStateHandler{
    ...
    protected String mUserID = "b9.49.29.1f.91.78.ea.3d.e9.35";
    ...
    protected Notification getNotification(){
        Intent notificationIntent = new Intent(this, USleep.class); //open main activity when user clicks on notification
